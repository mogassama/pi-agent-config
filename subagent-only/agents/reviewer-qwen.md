---
name: reviewer-qwen
description: Same reviewer, on Qwen 3.8 Max. Temporary, for the anime-etl comparison only — delete it once the model decision is made.
model: qwen-paygo/qwen3.8-max
